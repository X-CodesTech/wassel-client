                ...
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>
                    {customer.contactPerson && (
                      <div className="text-sm">Contact: {customer.contactPerson}</div>
                    )}
                    {customer.email && (
                ...
                <CardContent className="flex-grow overflow-hidden">
                  <div className="space-y-2">
                    <div className="text-sm font-medium text-gray-500">
                      {customer.priceItems.length ? `${customer.priceItems.length} custom prices` : "No custom pricing"}
                    </div>
                    {customer.priceItems.length > 0 && (
                      <div className="border-t pt-2">
                        <div className="flex justify-between text-sm mb-1">
                          <span className="font-medium">Sample Custom Prices:</span>
                        </div>
